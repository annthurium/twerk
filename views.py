...
def list_tweets():
    user_1_screen_name = strip_leading_ampersand(request.form['user_1_screen_name'])
    user_2_screen_name = strip_leading_ampersand(request.form['user_2_screen_name'])
...
def strip_leading_ampersand(str):
    if str[0] == '@':
        str.pop(0)
    return str
